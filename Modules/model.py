...
class Model:
    ...
    penalty: if the loss function includes a penalty (default: False)
    ...
    def train(self, data, nEpochs, batchSize, **kwargs):
        ...
        while epoch < nEpochs \
            ...
            while batch < nBatches \
                ...
                # Set the ordering
                xTrainOrdered = xTrain[:,:,self.order].to(device) # B x F x N
                ...
                if (epoch * nBatches + batch) % validationInterval == 0:
                    ...
                    # Set the ordering
                    xValidOrdered = xValid[:,:,self.order].to(device) # BxFxN
    ...
    def evaluate(self, data):
        ...
        xTestOrdered = xTest[:,:,self.order].to(device)
